...
Core transformation and diagnostics module for the
Data Normalization Assistant project.
...
- Transformation preview sorting
- Reusable pandas code generation

MAIN COMPONENTS
--------------------------------------------------

Transformation Class
    Reusable column and dataframe transformations.

Diagnostics
    Dataset and column-level health metrics.
...
Reporting Utilities
    Generate:
    - invalid format reports
    - transformation masks
    - duplicate reports
    - missing value reports

Code Generation
    Produces reusable pandas transformation pipelines
    based on selected cleaning steps.

DESIGN GOALS
--------------------------------------------------

- Non-destructive transformations
- Traceable cleaning operations
- Explainable validation reporting
- Reusable transformation workflows
- Realistic data engineering simulation
"""
