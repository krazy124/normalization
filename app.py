...
A Streamlit-based data cleaning and normalization tool
designed to simulate real-world data engineering workflows.
...
transformations.py
    Data transformation engine, diagnostics, reporting,
    validation logic, transformation masks, and export utilities.

FEATURES
--------------------------------------------------

- Generate synthetic dirty datasets
- Upload CSV files
- Preview transformations before applying
- Column-level cleaning and normalization
- Data quality metrics and health dashboards
- Invalid format reporting
- Transformation mask tracking
- Export cleaned datasets and reusable transformation code
...
- Preserve failed conversions instead of destructive cleaning
- Make transformations explainable and traceable
- Simulate realistic data engineering cleaning workflows
- Generate reusable transformation code for pipelines
"""
